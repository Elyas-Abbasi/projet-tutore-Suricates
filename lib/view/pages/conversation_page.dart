...
class _ConversationPageState extends State<ConversationPage> {
  Stream getConversation() {
    return FirebaseFirestore.instance
        ...
        .where(
          'currentUID',
          isEqualTo: globals.currentUser!.uid,
        )
        .orderBy('time')
        .snapshots();
  }
      ...
      child: StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          if (snapshot.hasData) {
                    ...
                    return FutureBuilder(
                      ...
                      builder: (context, snapUser) {
                        return ConversationItem(
                          conv: conversation,
                          urlAd: snapAd.data.toString(),
                          urlUser: snapUser.data.toString(),
                          onTapItem: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ChatPage(
                                  chatParams: ChatService(
                                    globals.currentUser!,
                                    GlobalUser(
                                      conversation.peerUID,
            ...
            return const Center(
              child: Text(
                r'Démarrez votre première discussion en proposant \n un produit ou en faisant une offre !',
